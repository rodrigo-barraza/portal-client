...
import { EDGE_DIRECTION_CONFIG, EDGE_TYPE_CONFIG, EDGE_TYPES } from "./topologyConfig";
  ...
  return (
    <div className={styles["legend"]}>
      ...
      <div className={styles["legend-item"]}>
        <div className={`${styles["legend-dot"]} ${styles["legend-dot-healthy"]}`} />
        <span>Healthy</span>
      </div>
      <div className={styles["legend-item"]}>
        <div className={`${styles["legend-dot"]} ${styles["legend-dot-down"]}`} />
        <span>Down</span>
      </div>
      ...
      {typeEntries.map(({ type, colors }) => {
        ...
        return (
          <ToggleComponent
            ...
            label={
              <span className={styles["legend-toggle-label"]} title={`${visible ? "Hide" : "Show"} ${typeClusterLabel(type)}`}>
                <span
      ...
      <div className={styles["legend-item"]}>
        <div className={`${styles["legend-line"]} ${styles["legend-line-optional"]}`} />
        <span>Optional</span>
      </div>
