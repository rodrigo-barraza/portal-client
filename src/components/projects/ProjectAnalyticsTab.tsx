...
export default function ProjectAnalyticsTab({
  ...
  const cards = overview
    ? [
        ...
        {
          label: "Avg Duration",
          value: formatSessionDuration(overview.avgSessionDuration),
        },
        ...
        <div className={styles["analytics-cards"]}>
          {cards.map((card) => (
            <div key={card.label} className={styles["analytics-card"]}>
              ...
              <span className={styles["analytics-card-label"]}>
                {card.label}
              </span>
            </div>
          ))}
          ...
          <div className={styles["analytics-page-list"]}>
            {pages.slice(0, 5).map((page) => (
              <div key={page.pagePath} className={styles["analytics-page-row"]}>
                <span
                  className={styles["analytics-page-path"]}
                  title={page.pagePath}
                >
                  {page.pagePath}
                </span>
